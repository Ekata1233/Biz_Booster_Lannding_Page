  ...
  return (
    <>
      ...
      <section className="py-12 md:py-16 bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className='container mx-auto px-4 md:px-6'>
          <div className='flex flex-col lg:flex-row-reverse items-center justify-between gap-8 md:gap-12 lg:me-30 lg:ms-25'>
            {/* Text Content */}
            <div className='w-full lg:w-1/2 space-y-4 md:space-y-6'>
              <div className="inline-flex items-center px-3 py-1 rounded-full bg-blue-100 text-blue-700 text-sm font-medium mb-2">
                <span className="w-2 h-2 bg-blue-600 rounded-full mr-2 animate-pulse"></span>
      ...
      <section className="py-12 bg-gradient-to-r from-blue-600 to-blue-700">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-blue-100 text-base md:text-lg mb-6 md:mb-8 max-w-2xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4">
            <Link href="/contact" className="inline-block">
              <button className="bg-white text-blue-600 hover:bg-gray-100 px-6 md:px-8 py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 text-sm md:text-base w-full sm:w-auto">
                Get Started Today
              </button>
            </Link>
            <Link href="tel:+919765303735" className="inline-block">
              <button className="border border-white text-white hover:bg-blue-700 px-6 md:px-8 py-3 rounded-lg font-semibold transition-all duration-300 text-sm md:text-base w-full sm:w-auto">
                Contact Support
              </button>
            </Link>
          </div>
