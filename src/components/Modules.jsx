  ...
  const modules = [
    {
      id: 1,
      title: "Franchise Module",
      icon: "/Franchise-Icons-01-01.png",
      desc: "This provides you ready-to-launch business model with partners and entrepreneurs.",
    },
    {
      id: 2,
